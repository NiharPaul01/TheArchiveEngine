...
namespace TheArchiveEngine {
	...
	void ImGuiLayer::OnAttach()
	{
		...
		// TEMPORARY: should eventually use TheArchiveEngine key codes
	...
	void ImGuiLayer::OnEvent(Event& event)
	{
		...
		dispatcher.Dispatch<MouseMovedEvent>(AE_BIND_EVENT_FN(ImGuiLayer::OnMouseMovedEvent));
		dispatcher.Dispatch<MouseScrolledEvent>(AE_BIND_EVENT_FN(ImGuiLayer::OnMouseScrolledEvent));
